...
class User(BaseModel, db.Model):
    ...
    name = db.Column(db.String(32), unique=True, nullable=False)  # 用户昵称，非空
    password_hash = db.Column(db.String(128), nullable=False)  # 加密后的用户密码
